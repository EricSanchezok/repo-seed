...
const CORE = {
  baseline: {
    ...
    benefit: 'Keeps resident instructions, repository orientation, review policy, deterministic verification, and safe upgrades available in every managed repository.',
    ...
    recommendWhen: [],
    reviewContribution: 'Resident instructions, project review policy, documentation orientation, manifest ownership, and the upgrade channel stay coherent.',
    verifyCommands: [
