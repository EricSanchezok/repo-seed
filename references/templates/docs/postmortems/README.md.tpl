...
A postmortem is not a decision record ([__DECISIONS_PATH__/](../../__DECISIONS_PATH__/)), which preserves durable rationale. It is a backward-looking record of a failure: what broke, the mechanism, why every safety net missed it, and the concrete guardrails added so the same class of bug fails loudly next time.
