...
English is the working language of this repository. This document covers contributor setup, daily workflow, and the commands that matter. Commands live in the root [AGENTS.md](../AGENTS.md); durable decision rationale lives in [__DECISIONS_PATH__](../__DECISIONS_PATH__/).
